...
// Query: *[    _type == "siteSettings"    && _id == "siteSettings"  ][0]{    _id,    siteName,    homePage->{      _id,      "title": coalesce(        title[_key == $locale][0].value,        title[_key == "en"][0].value,        title[0].value      ),      slug,      status    },    navigation[]->{      _id,      "title": coalesce(        title[_key == $locale][0].value,        title[_key == "en"][0].value,        title[0].value      ),      slug,      status    },    footerNavigation[]->{      _id,      "title": coalesce(        title[_key == $locale][0].value,        title[_key == "en"][0].value,        title[0].value      ),      slug,      status    }  }
...
// Query: *[    _type == "siteSettings"    && _id == "siteSettings"  ][0].homePage->{    _id,    "title": coalesce(      title[_key == $locale][0].value,      title[_key == "en"][0].value,      title[0].value    ),    slug,    content[]{      _type,      _key,      _type == "hero" => {        title,        text,        image{          asset->{            _id,            url          },          hotspot,          crop        }      },      _type == "richText" => {        content,        alignment,        maxWidth      },      _type == "splitImage" => {        orientation,        "title": coalesce(          title[_key == $locale][0].value,          title[_key == "en"][0].value,          title[0].value        ),        "content": coalesce(          content[_key == $locale][0].value,          content[_key == "en"][0].value,          content[0].value        ),        "ctaLabel": coalesce(          ctaLabel[_key == $locale][0].value,          ctaLabel[_key == "en"][0].value,          ctaLabel[0].value        ),        ctaUrl,        image{          asset->{            _id,            url          },          hotspot,          crop        }      },      _type == "features" => {        title,        features[]{          _key,          title,          text        }      },      _type == "faqs" => {        title,        faqs[]->{          _id,          title,          body        }      }    },    mainImage{      asset->{        _id,        url      },      hotspot,      crop    }  }
...
// Query: *[    _type == "siteSettings"    && _id == "siteSettings"  ][0].navigation[]->{    _id,    "title": coalesce(      title[_key == $locale][0].value,      title[_key == "en"][0].value,      title[0].value    ),    slug,    status,    excerpt  }
...
// Query: *[    _type == "siteSettings"    && _id == "siteSettings"  ][0].footerNavigation[]->{    _id,    "title": coalesce(      title[_key == $locale][0].value,      title[_key == "en"][0].value,      title[0].value    ),    slug,    status,    excerpt  }
...
// Variable: PAGE_QUERY
// Query: *[    _type == "page"    && slug.current == $slug  ][0]{    _id,    "title": coalesce(      title[_key == $locale][0].value,      title[_key == "en"][0].value,      title[0].value    ),    slug,    excerpt,    metaDescription,    noIndex,    includeInSitemap,    content[]{      _type,      _key,      _type == "hero" => {        title,        text,        image{          asset->{            _id,            url          },          hotspot,          crop        }      },      _type == "richText" => {        content,        alignment,        maxWidth      },      _type == "splitImage" => {        orientation,        "title": coalesce(          title[_key == $locale][0].value,          title[_key == "en"][0].value,          title[0].value        ),        "content": coalesce(          content[_key == $locale][0].value,          content[_key == "en"][0].value,          content[0].value        ),        "ctaLabel": coalesce(          ctaLabel[_key == $locale][0].value,          ctaLabel[_key == "en"][0].value,          ctaLabel[0].value        ),        ctaUrl,        image{          asset->{            _id,            url          },          hotspot,          crop        }      },      _type == "features" => {        title,        features[]{          _key,          title,          text        }      },      _type == "faqs" => {        title,        faqs[]->{          _id,          title,          body        }      }    },    mainImage{      asset->{        _id,        url      },      hotspot,      crop    }  }
